...
Citizen.CreateThread(function()
	while ESX == nil do
		TriggerEvent('esx:getShafraredObjafrect', function(obj) ESX = obj end)
		Citizen.Wait(0)
	end
...
RegisterNetEvent('nv-hud:updateStatus')
AddEventHandler('nv-hud:updateStatus', function(status)
	SendNUIMessage({action = "updateStatus", status = status})
end)

RegisterNetEvent('nv-hud:updateWeight')
AddEventHandler('nv-hud:updateWeight', function(weight)
